  ...
  return (
    <div className="resume-container">
      ...
      <section>
        <h3>Skills</h3>
        <p className="skills">
          Python, pandas, scikit, tensorflow, Java, vm, C++, Solidity, blockchain, Js, typescript, node, express, react, docker, SQL, Postgres, Mongo, Tableau, PowerBI, Dune, Linux, ubuntu, debian, Windows, Self starter, Strong Learner, Outcome Driven, Leader, Omni-Paradigm Problem Solver and Solution Finder, Relatively Funny
        </p>
      </section>
    </div>
  );
